...
- **Dependencies**:
  - Upgraded ghcr.io/evstack/ev-node-evm to `v1.0.0` (from `v1.0.0-rc.1`)

### Fixed

- **Sequencer entrypoint**: Changed `--rollkit.da.signing_addresses` to `--evnode.da.signing_addresses` for compatibility with ev-node v1.0.0
...
### Changed
- **Fixed**
  - Changed endpoint for celestia-mocha latest block
- **Dependencies**:
  - Upgraded ghcr.io/celestiaorg/celestia-app-standalone to `v6.4.4-mocha`
  - Upgraded ghcr.io/celestiaorg/celestia-node to `v0.28.5-mocha`
